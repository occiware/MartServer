...
/**
 * Utility interface for parsing request entry and transform a response to target media type.
 * @author cgourdin
 */
public interface IRequestParser {
    
    /**
     * The main method to parse all the input query and load this utility object.
     * @param headers
     * @param request 
     */
     ...
     * @param categoryFilter if path contains a category, interface is filtered for this category.
     * @param user
     * @return a response object to return to client.
     */
